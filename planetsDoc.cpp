...
CplanetsDoc::CplanetsDoc() noexcept
{
...
void CplanetsDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CplanetsDoc::InitializeSearchContent()
{
...
void CplanetsDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
